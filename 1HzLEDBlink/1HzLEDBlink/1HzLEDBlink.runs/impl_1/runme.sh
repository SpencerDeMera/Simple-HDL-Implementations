...
HD_PWD='G:/My Drive/_iCloud/EGEC Classes/HDL/Verilog/1HzLEDBlink/1HzLEDBlink/1HzLEDBlink.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_blink_1hz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_blink_1hz.tcl -notrace
