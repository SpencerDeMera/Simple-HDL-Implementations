...
HD_PWD='G:/My Drive/_iCloud/EGEC Classes/HDL/Verilog/1HzLEDBlink/1HzLEDBlink/1HzLEDBlink.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_blink_1hz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_blink_1hz.tcl
