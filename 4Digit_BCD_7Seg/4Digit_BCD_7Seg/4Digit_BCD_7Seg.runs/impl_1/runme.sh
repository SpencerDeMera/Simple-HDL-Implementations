...
HD_PWD='G:/My Drive/_iCloud/EGEC Classes/HDL/Verilog/4Digit_BCD_7Seg/4Digit_BCD_7Seg/4Digit_BCD_7Seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FourDigit_BCD_7Seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FourDigit_BCD_7Seg.tcl -notrace
