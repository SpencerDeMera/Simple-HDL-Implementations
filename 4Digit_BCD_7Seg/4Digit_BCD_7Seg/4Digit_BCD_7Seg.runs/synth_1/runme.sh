...
HD_PWD='G:/My Drive/_iCloud/EGEC Classes/HDL/Verilog/4Digit_BCD_7Seg/4Digit_BCD_7Seg/4Digit_BCD_7Seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FourDigit_BCD_7Seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FourDigit_BCD_7Seg.tcl
